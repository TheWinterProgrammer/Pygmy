...
const ALL_ITEMS = [
  ...
  { icon: '📅', label: 'Social Scheduler', path: '/social-scheduler', group: 'Site' },
  { icon: '💬', label: 'Canned Responses', path: '/canned-responses', group: 'Site' },
  { icon: '👥', label: 'Team Members',     path: '/team',              group: 'Site' },
